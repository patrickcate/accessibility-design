...
// After the Drupal caches are cleared, reload the browser.
gulp.task('cache-clear', ['drupal'], function () {
  browserSync.reload();
});
...
gulp.task('watch', function () {
  ...
  // gulp.watch(['**/*.{html,md,markdown,yaml,yml,css}', '!./_site/**/*.*'], ['jekyll-rebuild']);
  //gulp.watch(config.drupal.src, ['cache-clear']);
});
